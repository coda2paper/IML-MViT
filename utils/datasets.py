...
class base_dataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        original_width, original_height = tp_shape
        if max(original_width, original_height) > 1024:
            ...
            # 调整图片大小
            tp_img = tp_img.resize((new_width, new_height), Image.ANTIALIAS)
...
if __name__ == "__main__":
    ...
    # data = mani_dataset(r'/home/root123/wrj/dataset/forgery_dataset/realistic-tampering-dataset/Nikon_D7000', edge_width=5, transform=transform, if_return_shape=True)
    data = json_dataset('/workstation/datasets/casia2/casia.json', mask_edge_generator=5, transform_albu=transform)
